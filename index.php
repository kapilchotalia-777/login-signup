...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $exits = false;
    if (($password == $confirm_password) &&  $exits == false) {
        $sql = "insert into 'user' ('username', 'password') values ('$username', '$password', current_tiemstamp())";
...
<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Success!</strong> you can now sign in your account.
